...
<hr style="">
<h3 style="text-align: center; text-decoration: underline"><strong><span>  LISTE DES LIVRAISONS</span></strong></h3>
...
<table class="table table-striped GeneratedTable" border="0.1" style="text-align: center; height:20px; padding-top: 2px; padding-bottom: -5px;">
    <thead style="margin-top: 15px">
        <tr style="margin-top: 15px;">
            ...
            <th style="width: 21%; margin-top: 15px">LIVREUR</th>
    ...
    <tbody >
        @foreach ($items as $item)
                <tr >
                    ...
                    <td>{{$item->delivery_person->first_name}} {{$item->delivery_person->last_name}}</td>
                    <td> {{$item->delivery_person->phone}}</td>
