...
<hr style="margin-top:20px;"/>
        ...
        <tbody>
            <tr>
                <td style="width:100%; padding: 10px 0px;">
                    <div class="center">
                    <div> <strong> Bon de livraison </strong> </div>
                    </div>
                </td>
            </tr>
        </tbody>
        ...
        <tr>
            <td style="width:70%">
                <p style="font-size: 12px">
                    <strong>DETAIL DE L'ACHAT   </strong> <br> <br>
                    ...
                    {{Carbon\Carbon::parse($items?->delivery_date)->locale('fr')->isoFormat('Do MMMM YYYY')}} <br>
            ...
            <td style="width:30%">
                <p style="font-size: 12px">
                    ...
                    <br>
                    <strong>Entreprise : </strong>{{$items?->supplier?->compagny}}
                    <br>
                    @endif
    ...
    @if ($items?->procurement_details->count())
    <table id="invoice" style=" border : solid 1px #c6c4c6; font-size : 12px; margin-top: 0px !important;" class="tableau ">
        ...
        <tr>
            ...
            <th class="sorting" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="background:#ededed; width: 10%;" aria-label="Ship Country: activate to sort column ascending">PRIX</th>
        ...
        <tbody>
            @foreach($items->procurement_details as $item)
                <tr role="row" class="odd">
                    ...
                    <td style="text-align : right">{{ number_format($item->unit_price * $item->quantity?? 0, 0, ' ', ' ')  }}</td>
                </tr>
            @endforeach
