...
class StockProduitRepository extends Repository
{
    ...
    public function sale_stock(){
        ...
        $query = StockProduct::selectRaw('products.price, products_stock.product_id, products_stock.id, products.name AS product_name, products.image, products_stock.quantity, SUM(products_stock.quantity* products.price) AS stock_value')
